...
class _WeatherDashboardState extends State<WeatherDashboard>
  ...
  DatabaseReference temp = FirebaseDatabase.instance.ref('/user1').child('temp');
  DatabaseReference humi = FirebaseDatabase.instance.ref('/user1').child('humi');
  DatabaseReference light = FirebaseDatabase.instance.ref('/user1').child('lux');
